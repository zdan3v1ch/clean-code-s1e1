...
let taskInput=document.querySelector(".add-block__input");
// var addButton=document.getElementsByTagName("button")[0];//first button
let addButton=document.querySelector(".add-block__button");

// var incompleteTaskHolder=document.getElementById("incompleteTasks");//ul of #incompleteTasks
let incompleteTaskHolder=document.querySelector(".task-list_incomplete");//ul of #incompleteTasks
// var completedTasksHolder=document.getElementById("completed-tasks");//completed-tasks
let completedTasksHolder=document.querySelector(".task-list_complete");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-list__input input input_type-text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button task-list__button_edit";

    deleteButton.className="button task-list__button_delete";
